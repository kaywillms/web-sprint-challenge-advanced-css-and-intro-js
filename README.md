...
1. How would you describe acessibility on the web to someone new to programming?
   Tools or written code designed to add people that are impaired.
2. Talk about 3 different things you can do to ensure your website is accessible.
   Use semantic HTLM to define areas in my code for screen readers.
   Use Alt text on images that are added to site.
   Chosing correct color to aid color blindness.
3. How would you explain the concept of a variable to someone new to programming?
   Variables are like storage container that store data.
4. What is the purpose of using functions in code?
   Functions are reusalbe code that can be recall in another section of you code
