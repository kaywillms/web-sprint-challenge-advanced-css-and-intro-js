...
console.log(artists[2].name = "Vincent Van Gogh")
...
function get20s(data) {
  ...
  for (let i = 0; i < data.length; i++) {
    if (data[i].includes("1907 - 1954", "1904 - 1989")) {
      return data[i].name;
    } else {
...
function removeArtist(array, index) {
  ...
  let itemRemove = array.indexOf(index);
...
function addArtist(array) {
  ...
  array.push({
    ...
    bio: "Would love to pass this JS sprint but we will see what happens"
  })
